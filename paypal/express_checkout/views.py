...
from paypal.express_checkout.facade import (
	capture_order,
...
class SuccessResponseView(PaymentDetailsView):
	...
	def handle_payment(self, order_number, total, **kwargs):
		...
		try:
			...
			logger.warning(
				"Unable to capture order for token %s: %s", self.token, e.message
			)
			raise UnableToTakePayment(
				_(
					"A problem occurred during payment capturing - please try again later"
				)
			)
