...
def get_landing_page():
	...
	if landing_page not in (
		LANDING_PAGE_LOGIN,
		LANDING_PAGE_BILLING,
		LANDING_PAGE_NO_PREFERENCE,
	):
...
class PaymentProcessor:
	...
	def build_refund_order_request_body(self, amount, currency):
		return {"amount": {"value": format_amount(amount), "currency_code": currency}}
