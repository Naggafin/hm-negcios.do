			...
			fields=[
				...
				(
					...
					models.DecimalField(
						...
						help_text="Enter upper limit of this weight band in kg. The lower limit will be determined by the other weight bands.",
						max_digits=12,
					),
				),
				(
			...
			fields=[
				...
				(
					...
					models.DecimalField(
						...
						max_digits=12,
						decimal_places=3,
						help_text="Default product weight in kg when no weight attribute is defined",
					),
				),
				(
					"countries",
