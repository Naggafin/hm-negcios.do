	...
	operations = [
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"rating",
					models.FloatField(editable=False, verbose_name="Rating", null=True),
				),
				(
					"date_created",
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"value_text",
					models.TextField(blank=True, verbose_name="Text", null=True),
				),
				(
					"value_integer",
					models.IntegerField(blank=True, verbose_name="Integer", null=True),
				),
				("value_boolean", models.NullBooleanField(verbose_name="Boolean")),
				(
					"value_float",
					models.FloatField(blank=True, verbose_name="Float", null=True),
				),
				(
					"value_richtext",
					models.TextField(blank=True, verbose_name="Richtext", null=True),
				),
				(
					"value_date",
					models.DateField(blank=True, verbose_name="Date", null=True),
				),
				(
					"value_file",
					models.FileField(
